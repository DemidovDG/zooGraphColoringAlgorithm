...
//////////////////////////////////////////////////
    ...
    public static void main(String[] args) {
        ...
        // Удалить связь, что "Имя1" и "Имя2" не могут находится в одмно вольере:
        ...
        z.edge("Тигр8", "Тигр1Тигр", true);
        z.edge("Тигр9", "Тигр1Тигр", true);
        ...
        z.add("Гепард4");
        z.add("Гепард5");
        z.edge("Гепард", "Гепард2", true);
        z.edge("Гепард", "Гепард3", true);
        z.edge("Гепард1", "Гепард4", true);
        z.edge("Гепард1", "Гепард5", true);
        z.edge("Гепард2", "Гепард5", true);
        z.edge("Гепард3", "Гепард4", true);
